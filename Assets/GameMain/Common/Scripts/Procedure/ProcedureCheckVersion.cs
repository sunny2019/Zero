...
namespace GameMain
{
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        private void RequestVersion()
        {
            ...
            string screenResolution = Utility.Text.Format("{0} x {1} @ {2}Hz", Screen.currentResolution.width.ToString(), Screen.currentResolution.height.ToString(),
        ...
        private void UpdateVersion()
        {
            ...
            {
                GameEntry.Resource.UpdateVersionList(m_VersionInfo.VersionListLength, m_VersionInfo.VersionListHashCode, m_VersionInfo.VersionListZipLength,
                    m_VersionInfo.VersionListZipHashCode, m_UpdateVersionListCallbacks);
            }
        }
        ...
        private void OnWebRequestSuccess(object sender, GameEventArgs e)
        {
            ...
            {
                //TODO：从服务器获取到需要强制更新客户端,类似安卓的整包更新拉起安装，或者其他平台跳转url下载新的客户端
                GotoUpdateApp(this);
                return;
            }
        ...
        private string GetResourceVersionName()
        {
            ...
            return string.Format("{0}_{1}_{2}_{3}", splitApplicableGameVersion[0], splitApplicableGameVersion[1], splitApplicableGameVersion[2],
